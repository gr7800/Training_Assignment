...
import useFetchMoviesTvWithFilter from "../hooks/useFetchMoviesTvWithFilter";
...
const TvShows = () => {
  ...
  const { genres, genresList } = useFetchGenres("tv");
  const { moviesList } = useFetchMoviesTvWithFilter(
    page,
    genrevalue,
    sortingValue,
    "tv"

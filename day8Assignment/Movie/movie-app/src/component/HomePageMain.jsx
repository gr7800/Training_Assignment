...
const HomePageMain = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center text-white px-[3rem]">
      ...
      <div className="flex max-w-[70%] justify-center items-center h-12 w-full mt-[2.5rem]">
        <input className="w-[70%] h-[50px] px-5 py-3 rounded-l-full text-black" type="text" placeholder="Search for a movie or tv show..." value={searchQuerry} onChange={(e)=>setSearchQuerry(e.target.value)}/>
